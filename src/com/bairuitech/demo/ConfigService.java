package com.bairuitech.demo; //[B], Config Service
...
public class ConfigService {
	...
	{
		Toast.makeText(context, "Config Service LoadConfig", Toast.LENGTH_LONG).show();
        ...
        configEntity.port = share.getInt("port", 7231);
        configEntity.usage = share.getInt("usage", ConfigEntity.Master);
	...
	{
		Toast.makeText(context, "Config Service SaveConfig", Toast.LENGTH_LONG).show();
    	SharedPreferences  share = context.getSharedPreferences("perference",  Context.MODE_WORLD_WRITEABLE);  
        ...
        editor.putInt("usage", configEntity.usage);
