package com.bairuitech.demo; // [M]:->[D]
...
public class LiveVideoActivity extends Activity implements AnyChatBaseEvent{
    ...
    {
		Toast.makeText(getApplicationContext(), "M3", Toast.LENGTH_SHORT).show();
	...
	protected void onRestart() {
		Toast.makeText(getApplicationContext(), "M4", Toast.LENGTH_SHORT).show();
    	super.onRestart();
    	anychat.UserCameraControl(userID, 1);
		anychat.UserSpeakControl(userID, 1);
		bOnPaused = false;
    ...
    protected void onResume() {
    	Toast.makeText(getApplicationContext(), "M5", Toast.LENGTH_SHORT).show();
    	super.onResume();

    }

    protected void onPause() {
    	Toast.makeText(getApplicationContext(), "M6", Toast.LENGTH_SHORT).show();
    	super.onPause();
    	bOnPaused = true;
		if(bVideoOpened)
		{
    ...
    protected void onDestroy(){
    	Toast.makeText(getApplicationContext(), "M7", Toast.LENGTH_SHORT).show();
    	mTimer.cancel();
		anychat.LeaveRoom(-1);
	...
	public void OnAnyChatConnectMessage(boolean bSuccess) {
		...
		Toast.makeText(getApplicationContext(), "M8", Toast.LENGTH_SHORT).show();
	}

	@Override
	public void OnAnyChatEnterRoomMessage(int dwRoomId, int dwErrorCode) {
		Toast.makeText(getApplicationContext(), "M9", Toast.LENGTH_SHORT).show();
		if(dwErrorCode == 0)
		{
	...
	public void OnAnyChatLinkCloseMessage(int dwErrorCode) {
		...
		Toast.makeText(getApplicationContext(), "M10", Toast.LENGTH_SHORT).show();
		if(bVideoOpened)
		{
	...
	public void OnAnyChatLoginMessage(int dwUserId, int dwErrorCode) {
		Toast.makeText(getApplicationContext(), "M11", Toast.LENGTH_SHORT).show();
	}

	@Override
	public void OnAnyChatOnlineUserMessage(int dwUserNum, int dwRoomId) {
		Toast.makeText(getApplicationContext(), "M12", Toast.LENGTH_SHORT).show();
	}

	@Override
	public void OnAnyChatUserAtRoomMessage(int dwUserId, boolean bEnter) {
		Toast.makeText(getApplicationContext(), "M13", Toast.LENGTH_SHORT).show();
	}
}
